  ...
  return (
    <button
      ...
      className={cn(
        ...
        "focus-visible:ring-2 focus-visible:ring-white/20 focus-visible:ring-offset-2 rounded-lg",
        className
      )}
    ...
    >
      <div className="relative w-[72px] h-[72px]">
        ...
        <div className="absolute inset-[5px] rounded-full bg-black p-[2px]">
          <div className="w-full h-full rounded-full overflow-hidden bg-white/[0.05] flex items-center justify-center">
            {icon ? (
      ...
      <span className="text-[10px] font-mono text-white/30 group-hover:text-white/50 truncate max-w-[80px] uppercase tracking-wider transition-colors">
        {username}
      </span>
    </button>
  );
      ...
      >
            ...
            <div className="flex items-center gap-2">
              {isPaused && (
                <div className="flex items-center gap-1 text-white/80">
                  ...
                  <span className="text-xs font-mono">Paused</span>
                </div>
              )}
              {currentStory.type === "video" && (
                <button
                  type="button"
                  className="h-8 w-8 inline-flex items-center justify-center rounded-md text-white hover:bg-white/20 transition-colors"
        ...
        <div className="hidden md:flex absolute inset-y-0 left-0 right-0 items-center justify-between pointer-events-none px-4">
          <button
            type="button"
            className={cn(
              "h-10 w-10 rounded-full bg-white/10 text-white hover:bg-white/20 transition-colors pointer-events-auto inline-flex items-center justify-center",
          ...
          <button
            type="button"
            className="h-10 w-10 rounded-full bg-white/10 text-white hover:bg-white/20 transition-colors pointer-events-auto inline-flex items-center justify-center"
...
export { StoryViewer, StoryThumbnail };
